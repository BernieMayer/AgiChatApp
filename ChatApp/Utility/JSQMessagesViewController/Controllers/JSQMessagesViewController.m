...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForCellTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *strSectionName = [messageItem sectionName];
    
    if (strSectionName.length > 0)
    {
        return  [[NSAttributedString alloc] initWithString:strSectionName];
    }
...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForCellBottomLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"%@",[messageItem date]);
    NSLog(@"%@",[self getStringDateFromNSDate:[messageItem date] withFormat:@"hh:mm a"]);
    
    return [[NSAttributedString alloc] initWithString:[self getStringDateFromNSDate:[messageItem date] withFormat:@"hh:mm a"]];
    //return nil;
}
-(NSString*)getStringDateFromNSDate:(NSDate *)date withFormat:(NSString*)format
{
    ...
    NSDate *now = date;
    NSString *nsstr = [dateFormat stringFromDate:now];
    return  nsstr;
}
...
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapMessageBubbleAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [ self jsq_inputToolBarDismissKeyboard ];
...
//    [self.inputToolbar.contentView.textView.inputDelegate selectionDidChange:self.inputToolbar.contentView.textView];
    ...
    NSString *text = self.inputToolbar.contentView.textView.text;  //self.txtViewMessage.text; //self.inputToolbar.contentView.textView.text;
    if(![text  isEqual: @""])
    {
...
{
//    self.inputToolbar.contentView.rightBarButtonItem.imageView.image = [UIImage imageNamed:@"voice_message"];
    
    UIImage *btnImage = [UIImage imageNamed:@"sendMessage.png"];
    [self.inputToolbar.contentView.rightBarButtonItem setImage:btnImage forState:UIControlStateNormal];
...
-(void)jsq_inputToolBarDismissKeyboard
{
...
- (void)jsq_adjustInputToolbarHeightConstraintByDelta:(CGFloat)dy
{
    ...
    ///////====================================================//
    ////Developer
    ///set the fix height of the toolbar
    if (finalHeight > 150.0 )
    {
        finalHeight = 150.0;
    }
    ///////====================================================//
...
/////Developer
////Add this two methods for customize the view

#pragma mark - Button Profile Click

-(void) onButtonProfileClick
{
    
}
- (IBAction)btnProfileViewClick:(UIButton *)sender
{
    
    [self onButtonProfileClick ];
}


#pragma mark - Button DotMenu Click

-(void) onDotMenuClick
{
    
}
- (IBAction)btnDotMenuClick:(UIButton *)sender {
    
    [self onDotMenuClick];
}

#pragma mark - Button Attachment Click
...
- (IBAction)btn_Attachment:(UIButton *)sender{
...
//    [[NSUserDefaults standardUserDefaults] setBool:true forKey:@"showChat"];
...
-(void) configuration
{
    _imgGroupIcon.layer.cornerRadius = CGRectGetWidth(_imgGroupIcon.frame)/2.3;
    _imgGroupIcon.layer.masksToBounds = true;
