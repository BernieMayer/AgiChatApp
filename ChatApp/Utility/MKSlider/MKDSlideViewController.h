...
@property (nonatomic, assign) UIStatusBarStyle leftStatusBarStyle;  // default: UIStatusBarStyleLightContent
@property (nonatomic, assign) UIStatusBarStyle rightStatusBarStyle;  // default: UIStatusBarStyleLightContent
