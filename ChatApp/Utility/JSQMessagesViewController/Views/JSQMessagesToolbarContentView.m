...
const CGFloat kJSQMessagesToolbarContentViewHorizontalSpacingDefault = 15.0f;
...
//    self.textViewBackgroundImageView.layer.borderWidth = 5.0;
//    self.textViewBackgroundImageView.layer.borderColor = [[UIColor redColor] CGColor];
//    
}
