...
/////=========================add the developer ioutlets customize the JSQMessagesViewController===============//
@property (strong, nonatomic) IBOutlet UIButton *btnBack;
@property (strong, nonatomic) IBOutlet UIButton *btnViewProfile;
@property (strong, nonatomic) IBOutlet UIImageView *imgGroupIcon;
@property (strong, nonatomic) IBOutlet UIButton *btnDotMenu;
